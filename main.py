...
if __name__ == "__main__":
    ...
    # interface4 = LLM_Implementation_HuggingFace_Bert() 
    # interface5 = LLM_Implementation_HuggingFace_Decoder() 
    # ExecuteGUI([interface1, interface2, interface3, interface4, interface5])
